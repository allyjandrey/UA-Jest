 ...
 * - Tempo de trabalho
 * 
 * Essa classe deve ter um construtr publico para instânciar os atributos acima
 * 
 * Os métodos são:
 * -> getNome > Retorna o nome
 * -> getIdade > Retorna a idade
 * -> getEndereço > Retorna o endereço
 * -> getDadosCompletos > Retorna concatenando NOME, IDADE, GÊNERO e TELEFONE
 * -> getNomeETelefone > Retorna o nome e telefone
 * -> getTempoDeTrabalho > Retorna o tempo de trabalho
 * -> getTempoParaSeAposentar > Assuma que a idade de aposentadoria e 60 anos
